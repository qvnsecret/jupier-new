...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        if (interaction.guild.ownerId === interaction.user.id) return interaction.editReply({ content: `<:sucrown:1192079716954411019> You are the owner of the server so i can't change your name` })
