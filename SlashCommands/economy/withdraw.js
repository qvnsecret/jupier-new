    ...
    run: async (client, interaction, args) => {
        ...
        if (args.join(' ').toLocaleLowerCase() == 'all') {
            ...
            let embed = new MessageEmbed()
              .setColor("WHITE")
              .setDescription(`<:sueuro:1192590664458838067> You don't have any money in your bank.`)
            if (!money) return interaction.editReply({embeds :[embed]})
            db.subtract(`bank_${user.id}`, money)
            db.add(`money_${user.id}`, money)
            let embed5 = new MessageEmbed()
                .setColor("WHITE")
                .setDescription(` <:sulike:1192079393154138183> You have withdrawn all your coins.`);
           interaction.editReply({embeds :[embed5]})
            ...
            let embed6 = new MessageEmbed()
                .setColor("WHITE")
                .setDescription(`<:sudislike:1192079445956239401> Your Amount Is Not A Number!`)
            ...
            let embed4 = new MessageEmbed()
                .setColor("WHITE")
                .setDescription(`<:sudislike:1192079445956239401> You don't have enough money.`);
            ...
            let embed5 = new MessageEmbed()
                .setColor("WHITE")
                .setDescription(`<:sulike:1192079393154138183> You have withdrawn ${args[0]} coins.`);
