...
*/
        ...
        .setColor(`WHITE`)
        .setDescription(`> <:suusers:1192079885200531537> **User**: ${user} | ${user.id}\n> <:sueuro:1192590664458838067> **Money**: ${money}\n> <:sufire:1195274373796470924> **Bank**: ${bank}\n<:suinfo:1192126018077597777> **Bio**: ${bio}`)
