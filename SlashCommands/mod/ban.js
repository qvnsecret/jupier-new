...
},
{
    ...
    run: async(client, interaction, args) => {
        ...
        try{
            ...
            .setTitle(`<:suban:1192142284263800935> You were banned by ${interaction.member.user.tag}!`)
            ...
            await mentionedMember.ban({ reason: reason }).then(() => { //then ban the user
                ...
                .setTitle(`<:suban:1192142284263800935> ${mentionedMember.user.tag} was banned\nby ${interaction.member.user.tag}`)
                .setDescription(`Reason: ${reason}`)
            ...
            .setDescription('<:sudislike:1192079445956239401> **There was an error while banning this user!**')
